...
namespace IdentityServer4.Quickstart.UI
{
    ...
    {
        private readonly CustomerStore _users;
        ...
        private (Customer user, string provider, string providerUserId, IEnumerable<Claim> claims) FindUserFromExternalProvider(AuthenticateResult result)
        {
        ...
        private Customer AutoProvisionUser(string provider, string providerUserId, IEnumerable<Claim> claims)
        {
